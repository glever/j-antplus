...
public class MessageBus<T> implements Closeable {
     ...
     * </ul>
     *
     * @param listener   The listener to handle of events.
     * @param timeout    Time to wait for messages. Negative values mean indefinite.
     * @param nrMessages Number of messages to dispatch to this listener before discarting
