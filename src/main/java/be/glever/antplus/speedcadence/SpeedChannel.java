...
public class SpeedChannel extends AntChannel implements FluxProvider {
    ...
    private static final Log LOG = Log.getLogger(SpeedChannel.class);
     ...
     *
     * Allowed values:
     *  8118/32768 seconds (~4.04 Hz)
     * 16236/32768 seconds (~2.02 Hz)
     * 32472/32768 seconds (~1.01 Hz)
     *
     * TODO: Allow setting the frequency
     */
    public static final byte[] CHANNEL_PERIOD = ByteUtils.toUShort(8118);
     ...
     * @param device
     */
    public SpeedChannel(AntUsbDevice device) {
     ...
     * @param deviceNumber
     */
    public SpeedChannel(AntUsbDevice device, byte[] deviceNumber) {
        this.device = device;
        ...
        setChannelId(new AntChannelId(AntChannelTransmissionType.PAIRING_TRANSMISSION_TYPE, AntPlusDeviceType.Speed, deviceNumber));
