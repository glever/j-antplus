...
public class CadenceSlave {
    ...
    public AntChannel[] listDevices() throws AntException, ExecutionException, InterruptedException {
        ...
        ChannelPeriodMessage channelPeriodMessage = new ChannelPeriodMessage(channelNumber, CadenceChannel.CHANNEL_PERIOD);
