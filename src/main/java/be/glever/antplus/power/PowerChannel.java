...
public class PowerChannel extends AntChannel implements FluxProvider {
    ...
    /**
     * Pair with any (the first found) Power.
     *
     * @param device
     */
    ...
    public PowerChannel(AntUsbDevice device, byte[] deviceNumber) {
        ...
        setChannelId(new AntChannelId(AntChannelTransmissionType.PAIRING_TRANSMISSION_TYPE, AntPlusDeviceType.Power, deviceNumber));
